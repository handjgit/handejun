				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
										...
										<div class="widget-main bound">
											...
											<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/register/registerUser" method="post" class="form-group form-horizontal">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="tel" name="phone" type="text" value="" maxlength="11" minlength="11" class="form-control text-muted required isMobile"  placeholder="手机号"/>
															<i class="ace-icon fa fa-phone"></i>
														</span>
													</label>
													<select onchange="changeType()" id="regType" name="type">
													...
													<div  id ="hideDiv" style="display: none;">
														<label class="block clearfix">
															<span class="block input-icon input-icon-right">
																<input id="website" name="website" type="text" value=""  class="form-control text-muted required isMobile"  placeholder="官网"/>
															</span>
														</label>
														<label class="block clearfix">
															<span class="block input-icon input-icon-right">
																<input id="servQQ" name="servQQ" type="text" value=""  class="form-control text-muted required isMobile"  placeholder="客服QQ"/>
	 															</span>
														</label>
													</div>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="userId" name="name" type="text" value="${user.name}" maxlength="20" minlength="3" class="form-control required" placeholder="用户名" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; www.parttime.platform.com</font></h4></div>
