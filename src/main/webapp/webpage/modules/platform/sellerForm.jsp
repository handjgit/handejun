		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="score" htmlEscape="false" maxlength="20"  minlength="6"   class="form-control required"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35">
						<form:select path="type" class="form-control required">
							<form:option checked="true" value="2" label="商家"/>
						</form:select>
					</td>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>商家网址：</label></td>
					<td class="width-35">
						<form:input path="website" htmlEscape="false" maxlength="11"  minlength="11"   class="form-control required"/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>客服QQ：</label></td>
					<td class="width-35">
						<form:input path="servQQ" htmlEscape="false" maxlength="20"  minlength="1"   class="form-control required"/>
					</td>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>发布职位数：</label></td>
					<td class="width-35">
						<form:input path="pubCount" htmlEscape="false" maxlength="20"  minlength="6"   class="form-control required"/>
					</td>
				</tr>
		 	</tbody>
		</table>
