...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="tuser" action="${ctx}/platform/tuser/list?type=2" method="post" class="form-inline">
		...
		<c:forEach items="${page.list}" var="tuser">
			<tr>
				...
				<td>
    				...
    				<shiro:hasPermission name="platform:tuser:del">
						<a href="${ctx}/platform/tuser/delete?id=${tuser.id}" onclick="return confirmx('确认要删除该学生信息吗？', this.href)"   class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> 删除</a>
					</shiro:hasPermission> 
				</td>
			</tr>
		</c:forEach>
