...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="salaryBalance" action="${ctx}/platform/salaryBalance/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>职位id：</label></td>
					<td class="width-35">
					...
					<td class="width-35">
						<form:input path="salary" htmlEscape="false"    class="form-control required digits"/>
					</td>
				</tr>
				<tr>
