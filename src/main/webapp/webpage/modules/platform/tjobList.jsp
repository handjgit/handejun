	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="tjob">
			<tr>
				...
				<td>
					<shiro:hasPermission name="platform:tjob:view">
						<a href="#" onclick="openDialogView('查看职位发布', '${ctx}/platform/tjob/form?id=${tjob.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="platform:tjob:edit">
    					<a href="${ctx}/platform/tjob/shenhe?id=${tjob.id}"  class="btn btn-success btn-xs" ><i class="fa fa-edit"></i>审核通过</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="platform:tjob:del">
